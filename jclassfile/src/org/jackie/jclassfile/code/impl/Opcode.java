...
public enum Opcode {
	...
	TABLESWITCH(0xAA, Factories.SWITCHTABLE),
	LOOKUPSWITCH(0xAB, Factories.LOOKUPSWITCH),
	...
	INVOKEINTERFACE(0xB9, Factories.INVOKE_INTERFACE),
	...
	MULTIANEWARRAY(0xC5, Factories.MULTIARRAY),
